...
oriolgl@LAPTOP-296TEP2P:/mnt/c/users/oriol/documents/uni/4t curs/Primer semestre/TAB/Definitivas$ cd P3
oriolgl@LAPTOP-296TEP2P:/mnt/c/users/oriol/documents/uni/4t curs/Primer semestre/TAB/Definitivas/P3$ mkdir Project3
oriolgl@LAPTOP-296TEP2P:/mnt/c/users/oriol/documents/uni/4t curs/Primer semestre/TAB/Definitivas/P3$ cd Project3
oriolgl@LAPTOP-296TEP2P:/mnt/c/users/oriol/documents/uni/4t curs/Primer semestre/TAB/Definitivas/P3/Project3$ mkdir data
oriolgl@LAPTOP-296TEP2P:/mnt/c/users/oriol/documents/uni/4t curs/Primer semestre/TAB/Definitivas/P3/Project3$ cd data
oriolgl@LAPTOP-296TEP2P:/mnt/c/users/oriol/documents/uni/4t curs/Primer semestre/TAB/Definitivas/P3/Project3/data$ mkdir obesity
```
...
#El código no me funciona porque el wget no acepta el link de mega, pero una vez descargado, se descomprime.
```
...
We have `r nrow(obesity.genotype)` individuals genotyped, and a total of `r ncol(obesity.genotype)` SNPs.
...
<img src="http://bioinformatica.uab.cat/base/documents/sgbcursos/documents/description2019_11_20D18_0_15.png">
...
1. **SNPs with high rate of missing** - tipically, markers with a call rate less than 95% are removed from association analyses.
...
In the figure we compare F statistic and the Heterozygosity field obtained from `row.summary`.
...
<i class="fa fa-key"></i> A temptative Manhattan plot could look like [this](http://bioinformatica.uab.cat/base/documents/sgbcursos/documents/ManhattanPlot2019_11_21D13_30_17.png).

**Which SNPs are significant in this GWAS analysis?**

<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer:
rs6931936, rs7349742, rs12201995 and rs1935960.
</div>
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer:
Only SNPs rs7349742 and rs12201995 are NOT overlapping protein genes.
</div>
...
I think that the SNPs we have found need to undergo some other bioinformatic processes/studies before looking into the molecular field. That it because there may be other factors which we may have overlooked. Furthermore, both in the colorectal study and in the obesity study, there are SNPs which are really close over the line, and with a little difference in their p-value, they could have become non-significant. Therefore, these should undergo some other studies. However, those that are clearly above with a huge difference, and although they should also undergo some further studies, they could be potential candidates to be linked with the gene causing the disease (ot to be it themselves), which could be well determined by molecular studies, which would give us more information than we would get from SNPs with a p-value closer to the limit.
</div>
